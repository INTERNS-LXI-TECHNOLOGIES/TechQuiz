...
import com.lxisoft.service.dto.UserRegisterDto;
...
//        List<QnOption> qnOptions = new ArrayList<>();
    ...
    public ModelAndView userRegister(ModelAndView model)
    {
    ...
    public ModelAndView register(@ModelAttribute UserRegisterDto user)
    {
       ...
       /* UserDTO userDTO = new UserDTO();
        ...
        userService.registerUser2(user/*, password*/);
