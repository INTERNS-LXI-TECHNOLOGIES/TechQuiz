...
public class QuestionResourceIT {
    ...
    private static final QuestionLevel DEFAULT_QUESTIONLEVEL = QuestionLevel.EASY;
    private static final QuestionLevel UPDATED_QUESTIONLEVEL = QuestionLevel.MEDIUM;
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question()
            ...
            .questionlevel(DEFAULT_QUESTIONLEVEL);
        return question;
    }
    /**
    ...
    public void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getQuestionlevel()).isEqualTo(DEFAULT_QUESTIONLEVEL);
    }
    ...
    public void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].questionlevel").value(hasItem(DEFAULT_QUESTIONLEVEL.toString())));
    }
    ...
    public void getQuestion() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions/{id}", question.getId()))
            ...
            .andExpect(jsonPath("$.questionlevel").value(DEFAULT_QUESTIONLEVEL.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateQuestion() throws Exception {
        ...
        assertThat(testQuestion.getQuestionlevel()).isEqualTo(UPDATED_QUESTIONLEVEL);
    }
