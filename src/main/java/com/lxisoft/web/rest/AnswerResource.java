...
/**
 * REST controller for managing {@link com.lxisoft.domain.Answer}.
 */
@RestController
@RequestMapping("/api")
public class AnswerResource {
     ...
     */
    @GetMapping("/answers")
    public List<AnswerDTO> getAllAnswers(@RequestParam(required = false) String filter) {
        if ("question-is-null".equals(filter)) {
            log.debug("REST request to get all Answers where question is null");
            return answerService.findAllWhereQuestionIsNull();
        }
